...
def como_jogar(stdscr):
    como_jogar = "O jogo consiste na disputa entre dois gorilas, cada jogador vai ter que arremessar uma banana no adversário a fim de derrotá-lo. Cada projétil atingido no gorila contará como +50 pontos na pontuação do jogador, e ganha quem conseguir 150 pontos primeiro. Existem 3 dificuldades divididas em fácil, normal e difícil... Na primeira dificuldade a gravidade da lua Europa é igual a 9.8 (valor não correspondente a realidade) e a quantidade de obstáculos é normal. Na dificuldade 'normal' os gorilas estão em uma enorme cratera onde a gravidade da lua Europa passa a ser igual a 11 (valor não correspondente a realidade) e a quantidade de obstáculos é dobrada. No 'difícil' as condições são semelhantes a dificuldade anterior, mas devido ao combate explosivo travado na lua Europa, uma chuva de meteoros passa a consumir o local de combate, atrapalhando os gorilas."
